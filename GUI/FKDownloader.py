...
from GUI.FKEntry import ArtStationRun, HuabanRun, HuabanBoardRun, PinterestRun, PixivRun, Comic18Run, EHantaiRun
...
class FKUI_EHantaiDownloader(FKUI_UserHomeDownloader):
    title = "Ehentai 按作品"
    def __init__(self, *args, **kwargs):
        super(FKUI_EHantaiDownloader, self).__init__(*args, storeName="ehantai_save_path", userHomeName="漫画网址或中文关键字", **kwargs)
